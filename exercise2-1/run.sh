...
if [ "$(basename $(pwd))" != "exercise2-1" ]; then
...
if [ -d /opt/ros2-rt-rpi4/ ]; then
  ros2 launch inverted_pendulum_example_2_1 exercise2-1.launch.py
else
  ros2 launch inverted_pendulum_example_2_1 exercise2-1.launch.py rviz:=true
fi
